...
const About = () => {
  return (
    <>
      {/* ===== HERO / ABOUT ===== */}
     <section className="bg-black text-white px-4 pt-28 pb-16 min-h-[calc(100vh-64px)] flex items-center">
  <div className="mx-auto w-full max-w-4xl text-center">
    ...
    <p className="mx-auto mt-6 max-w-2xl text-base md:text-lg leading-relaxed text-white/65">
      ...
      with <span className="text-white/90">React</span>,{" "}
      ...
      <section id="education" className="bg-black py-20 px-4 text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 flex justify-center">
            <a
              href="#all-projects"
              className="group inline-flex items-center gap-2 rounded-2xl bg-white px-6 py-3 text-sm font-semibold text-black hover:bg-white/90 transition"
            >
              All Projects
...
<section id="all-projects" className="bg-zinc-950 py-20 px-4 text-white">
  <div className="mx-auto max-w-6xl">
    <div className="text-center">
      ...
      <p className="mt-3 max-w-2xl mx-auto text-white/65">
        A collection of CodeJam and practice projects. More real-world builds
        coming soon.
      </p>
    </div>
